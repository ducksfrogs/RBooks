...
myfa(A_fac, 1); cronbach(A_fac); omega.coef(A_fac)
B_fac <- SRdat[c(18,24,30,32,35)]
myfa(B_fac, 1); cronbach(B_fac); omega.coef(B_fac)
C_fac <- SRdat[c(1,2,5,7,8,36,37)]
myfa(C_fac, 1); cronbach(C_fac); omega.coef(C_fac)
D_fac <- SRdat[c(3,14,17,21,22)]
myfa(D_fac, 1); cronbach(D_fac); omega.coef(D_fac)
F_fac <- SRdat[c(23,25,26,28)]
myfa(F_fac,1); cronbach(F_fac); omega.coef(F_fac)
E_fac <- SRdat[c(6,9,11,13,15,20,29,31,33,34)]
myfa(E_fac, 1); cronbach(E_fac); omega.coef(E_fac)


#
myfa(SRdat, 2); myfa(SRdat, 3); myfa(SRdat, 4); myfa(SRdat, 5);
myfa(SRdat, 6); myfa(SRdat, 7); myfa(SRdat, 8); myfa(SRdat, 9);
myfa(SRdat, 10)
